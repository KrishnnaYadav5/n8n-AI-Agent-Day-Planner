...
- `AI Agent - Day Planner.json` - Main workflow configuration
- `n8n Canvas Screenshot.png` - Visual representation of the workflow
...
[KrishnnaYadav5](https://github.com/KrishnnaYadav5)
